...
function five_vtb() {
 ...
 Exodus.addEventListener('click', function(){
    ...
    p1.innerHTML = 'Рейтинг сбербанка = ' + a;
    p2.innerHTML = 'Рейтинг альфа-банка = ' + b;
    p3.innerHTML = 'Рейтинг Тинькофф = ' + c;
    p4.innerHTML = 'Рейтинг РОСБАНК = ' + d;
    p5.innerHTML = 'Рейтинг ВТБ = ' + e;
    return;
});
